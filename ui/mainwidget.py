...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEditScriptPath = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEditScriptPath.setObjectName("lineEditScriptPath")
        self.horizontalLayout_2.addWidget(self.lineEditScriptPath)
        ...
        self.horizontalLayout_6.addWidget(self.pushButtonImport)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "版本配置路径选择:"))
        self.pushButtonVersionConfig.setText(_translate("MainWindow", "路径选择"))
        ...
        self.pushButtonImport.setText(_translate("MainWindow", "导出"))
